...
venue: "Room 119-110, Waipapa Taumata Rau - The University of Auckland"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
address: "Room 119-110, ClockTower East Wing on City Campus, 24 Princes Street"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
latitude: "-36.850700754428"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "174.7698148398132"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "Postponed - TBD"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
<div class="alert alert-warning" style="font-size:1.75em; padding: 1em;"><strong>Update on 25 August:</strong> This event is postponed until the University is able to open for in-person teaching. An update will be sent out to registered attendees when the workshop can go ahead again. Register below so you don't miss out. </div>
